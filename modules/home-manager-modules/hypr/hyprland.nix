{ config, pkgs, userSettings, ...}:
{
    ...
    home.file.".config/hypr/dev-specific/monitor.conf".source = if userSettings.monitorType == "desktop" then ./dev-specific/monitor-desktop.conf else ./dev-specific/monitor-asusLaptop.conf;
    home.file.".config/hypr/dev-specific/monitor-desktop.conf".source = if userSettings.keyboard == "fullSize" then ./dev-specific/binds-fullSize-specific.conf else ./dev-specific/binds-laptop-specific.conf;
